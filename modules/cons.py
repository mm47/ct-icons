...
CHAR_AMPERSAND = "&"
CHAR_DOLLAR = "$"
CHARS_NOT_FOR_PASSWD = [CHAR_SQUOTE, CHAR_DQUOTE, CHAR_BSLASH, CHAR_SEMICOLON, CHAR_SPACE, CHAR_PARENTH_OPEN, CHAR_PARENTH_CLOSE, CHAR_PIPE, CHAR_AMPERSAND, CHAR_CARET, CHAR_DOLLAR]
...
CHERRY_BABY = 'cherry_baby'
CHERRY_LIME = 'cherry_lime'
...
'xml', 'c', 'cpp', 'perl', 'circle-pink', 'circle-purple', 'circle-blue',
CHERRY_BABY, CHERRY_LIME, CHERRY_PINK, 'folder_blue', 'folder_green',
'folder_grey', 'folder_orange', 'folder_pink', 'folder_purple',
'folder_red', 'folder_yellow', 'star_blue', 'star_mint', 'star_pink', 'star_purple', 'star_red',
'leaf_mint', 'leaf_orange', 'leaf_red', 'leaf_yellow', 'mail_env', 'terminal-green',
'mail_blue', 'mail_green', 'mail_orange', 'mail_pink', 'mail_purple', 'terminal-blue',
]
NODES_STOCKS_KEYS = [1,2,3,4,49,50,51,5,6,7,8,9,40,41,42,10,43,11,63,64,65,66,67,12,13,14,15,16,72,74,75,76,77,78,44,55,56,57,58,59,60,61,62,18,19,20,39,38,21,22,73,79,23,24,46,47,48,17,25,26,45,68,69,70,71,27,28,29,30,53,31,32,33,34,35,54,52,36,37]
NODES_STOCKS = {
 1: 'circle-green',
 2: 'circle-yellow',
 3: 'circle-red',
